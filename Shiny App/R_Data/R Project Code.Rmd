...
saveRDS(merged_data, file = "merged_data.RDS")
saveRDS(average_merge, file = "average_merge.RDS")
saveRDS(Eastern_Europe, file = "Eastern_Europe.RDS")
saveRDS(Latin_America, file = "Latin_America.RDS")
saveRDS(Middle_East, file = "Middle_East.RDS")
saveRDS(Africa, file = "Africa.RDS")
saveRDS(Western_Europe, file = "Western_Europe.RDS")
saveRDS(Asia, file = "Asia.RDS")
saveRDS(merged_GINI, file = "merged_GINI")
saveRDS(Eastern_Europe_GINI, file = "Eastern_Europe_GINI.RDS")
saveRDS(Latin_America_GINI, file = "Latin_America_GINI.RDS")
saveRDS(Middle_East_GINI, file = "Middle_East_GINI.RDS")
saveRDS(Africa_GINI, file = "Africa_GINI.RDS")
saveRDS(Western_Europe_GINI, file = "Western_Europe_GINI.RDS")
saveRDS(Asia_GINI, file = "Asia_GINI.RDS")
